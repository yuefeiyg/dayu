 ...
 */
@Service(value = "textSingleIntegralLabelCommand")
public class TextSingleIntegralLabelCommand implements InnerExportCommand {
    private static final Logger log = LoggerFactory.getLogger(TextSingleIntegralLabelCommand.class);
    ...
    public String process(String taskid, String note, String dataids, String tasktype, String ispass, String annotationobject) throws Exception {
        ...
        log.info("进入【文本单对象整体标注】TextSingleIntegralLabelCommand接口的process方法中，" +
                "taskid参数的值:{}，模板templateid：{}，标注对象：{}", taskid,annotationobject);
        /**
    ...
    public boolean auditExport(String templateid,String taskid,String  annotationobject,List<Map<String, Object>> sources) throws Exception {
        ...
        for (Map<String, Object> source :sources){
            ...
            for (DataContentWithBLOBs datacontent:contents){
                ...
                labelmap.put("templateid",templateid);
                labelmap.put("items",itemlist);

                datacontent.setAnninfos(JSON.toJSONString(labelmap));
...
//            String dsowner = (String) taskInfo.get("projectowner");
