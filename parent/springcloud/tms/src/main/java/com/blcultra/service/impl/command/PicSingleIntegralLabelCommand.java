 ...
 */
@Service(value = "picSingleIntegralLabelCommand")
public class PicSingleIntegralLabelCommand implements InnerExportCommand {
    private static final Logger log = LoggerFactory.getLogger(PicSingleIntegralLabelCommand.class);
    ...
    public String process(String taskid, String note, String dataids, String tasktype, String ispass, String annotationobject) throws Exception {
        ...
        if (tasktype.equals(Common.MODULE_TASK_TYPE_AUDIT)){
            ...
            if ("1".equals(ispass.trim())){
                ...
                //如果是审核任务，则执行auditexport方法，进行审核任务提交的逻辑。
