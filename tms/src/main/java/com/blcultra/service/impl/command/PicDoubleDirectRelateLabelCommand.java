 ...
 */
@Service(value = "picDoubleDirectRelateLabelCommand")
public class PicDoubleDirectRelateLabelCommand implements InnerExportCommand {
    private static final Logger log = LoggerFactory.getLogger(PicDoubleDirectRelateLabelCommand.class);
    ...
    public boolean auditExport(String taskid, String templateid , String annotationobject,List<Map<String, Object>> sources) throws Exception {
        ...
        for (Map<String,Object> source : sources){
            ...
            List<Map<String, Object>> relateItems = annotationObjectRelationInfoMapper.getPicRelateLableDataItems(querymap);



            List<Map<String ,Object>> relations = new ArrayList<>();
            //relatedataid, objectdataid, labelid, fromitemid, toitemid, sentenceid
