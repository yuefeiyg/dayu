 ...
 */
@Service(value = "adminStatisticService")
public class AdminStatisticService {
    ...
    public String adminStatistic(String userid,String dimension,String begintime,String endtime) {
        String res = null;
        try {
            if (dimension.equals(Common.STATISTIC_DIMENSION_USER)){
                //总览
                List<Map<String, Object>> overall = adminUserDimensionOverall(begintime, endtime);
                //detail
                List<Map<String, Object>> detail = adminUserDimensionDetail(begintime, endtime);
                ...
                //项目维度总览
                List<Map<String, Object>> overall = adminProjectOverall(begintime, endtime);
                //项目维度detail
                List<Map<String, Object>> detail = adminProjectDetail(begintime, endtime);
    ...
    //项目维度总览
    private List<Map<String, Object>> adminProjectOverall(String begintime , String endtime) throws Exception {

        List<Map<String,Object>> overall = new ArrayList<>();
        List<Map<String, Object>> pus = projectInfoMapper.getProjects();
    ...
    //项目维度detail
    private List<Map<String,Object>> adminProjectDetail(String begintime , String endtime) throws Exception {
    ...
    //admin   用户维度总览
    private List<Map<String,Object>> adminUserDimensionOverall(String begintime, String endtime) throws Exception {
        String res = null;
        List<Map<String,Object>> overall = new ArrayList<>();
        Map<String,Object> resmap = new HashMap<>();
        ...
        params.put("starttime",begintime);
        params.put("endtime",endtime);
        List<Map<String, Object>> list = taskInfoMapper.adminStatisticTaskSearch(params);
    ...
    //admin  用户维度detail
    private List<Map<String, Object>> adminUserDimensionDetail(String begintime, String endtime) throws Exception {
        //userid , u.username  查询所有用户
        List<Map<String, Object>> users = userMapper.adminGetUsers();
