...
/**
 * manager角色统计逻辑服务接口
 * Created by sgy05 on 2019/4/11.
 */
@Service(value = "managerStatisticService")
public class ManagerStatisticService {
    ...
    public String managerStatistic(String userid,String dimension,String begintime,String endtime,List<Map<String, Object>> pus) {

        String res = null;
        try {
            List<String> pids = new ArrayList<>();
            Map<String,Object> params = new HashMap<>();
            if (pus.size()>0 && pus != null){
                for (Map<String,Object> map :pus){
                    String projectid = String.valueOf(map.get("projectid"));
                    pids.add(projectid);
                }
            }
            if(pids.size() > 0){
                params.put("list",pids);

            }
            params.put("projectowner",userid);
            // projectid, projectname, projectowner
            List<Map<String, Object>> projects = projectInfoMapper.getProjectInfosByProjectOwner(params);
            ...
            if (dimension.equals(Common.STATISTIC_DIMENSION_USER)){
                ...
                //总览
                List<Map<String, Object>> overall = managerUserDimensionOverall(begintime, endtime, proids);
                //detail
                List<Map<String, Object>> detail = managerUserDimensionDetail(begintime, endtime, proids);

                Map<String, Object> resmap = new HashMap<>();
                resmap.put("type","memeber");
                resmap.put("overall",overall);
                resmap.put("detail",detail);
                ...
                //总览
                List<Map<String, Object>> overall = managerProjectOverall(begintime, endtime, projects);
                //detail
                List<Map<String, Object>> detail = managerProjectDetail(begintime, endtime, projects);
    ...
    //项目维度总览
    private List<Map<String, Object>> managerProjectOverall(String begintime , String endtime , List<Map<String, Object>> pus) throws Exception {
        ...
        for (Map<String,Object> project : pus){
            ...
            if (list != null && list.size()>0){
                ...
                pmap.put("annotationcount",annotationcount);//为了排序加的冗余字段
        ...
        SortUtil.SortByCompletion(overall,"annotationcount");
        return overall;
    }
    //项目维度detail
    private List<Map<String,Object>> managerProjectDetail(String begintime , String endtime , List<Map<String, Object>> pus) throws Exception {
    ...
    //用户维度detail
    private List<Map<String, Object>> managerUserDimensionDetail(String begintime, String endtime, List<String> proids) throws Exception {
        //userid , u.username
        ...
        for (Map<String,Object> user :users){
            ...
            params.put("role","user");
            List<Map<String, Object>> list = taskInfoMapper.pManagerStatisticTaskSearch(params);
            List<Map<String,Object>> tasktotaldatas = new ArrayList<>();//任务总数据量，不包含报废的任务
            List<Map<String,Object>> taskannotationdatas = new ArrayList<>();//标注总数据量
            List<Map<String,Object>> passdatas = new ArrayList<>();//通过数据量
            List<Map<String,Object>> returndatas = new ArrayList<>();//打回数据量
        ...
        SortUtil.SortByCompletion(userDDList,"completion");
        Map<String ,Object> datamap = new HashMap<>();
    ...
    //用户维度的总览
    private List<Map<String,Object>> managerUserDimensionOverall(String begintime, String endtime, List<String> proids) throws Exception {
        String res = null;
        List<Map<String,Object>> overall = new ArrayList<>();
        Map<String,Object> resmap = new HashMap<>();
        ...
        SortUtil.SortByCompletion(overall,"completion");
        return overall;
